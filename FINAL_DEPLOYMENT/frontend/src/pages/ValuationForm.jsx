...
export default function ValuationForm({ reportId: initialReportId, initialState, onSavedToDb, onBack, user, onLogout }) {
      ...
      render: () => (
        <div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10, marginBottom: 4 }}>
            ...
            <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", background: isBuySell ? "#fff3e0" : "#F3F6F5", border: `1.5px solid ${isBuySell ? "#e67e22" : "#D6DCE5"}`, borderRadius: 8, padding: "7px 14px", fontWeight: 700, fontSize: 13, color: isBuySell ? "#e67e22" : "#555", transition: "all 0.15s", userSelect: "none" }}>
                        ...
                        {[["radp","R-A-P-D (Anna)"],["bkd","B-K-D (Dhur)"]].map(([val,lbl])=>(
                          <button key={val} type="button"
                            ...
                            style={{padding:"3px 10px",fontSize:"12px",fontWeight:600,borderRadius:"5px",cursor:"pointer",border:"1.5px solid",
                              background:(prop.rateSystem||"radp")===val?"#0A6B50":"#f5f5f5",
                              color:(prop.rateSystem||"radp")===val?"#fff":"#555",
                              borderColor:(prop.rateSystem||"radp")===val?"#0A6B50":"#d0d0d0"}}>
                            {lbl}
                          </button>
                        ))}
                      </div>
                    ...
                    {(() => {
                      ...
                      return (
                        <div style={{gridColumn:"1 / -1"}}>
                              ...
                              return (
                                <div key={flag} style={{border:`1.5px solid ${active?"#f0c070":"#e5e7eb"}`,borderRadius:8,padding:"10px 12px",background:active?"#fffaf4":"#fafafa",transition:"all 0.15s"}}>
                                  <label style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",userSelect:"none",marginBottom:active?10:0}}>
                                    <input type="checkbox" checked={active} onChange={e=>upd(flag,e.target.checked)} style={{width:15,height:15,cursor:"pointer",accentColor:"#D4AF37"}}/>
                          ...
                          <div style={{marginTop:14,border:`2px solid ${pd.meetsMinReq===false?"#e74c3c":pd.meetsMinReq===true?"#10B981":"#e5e7eb"}`,borderRadius:8,padding:"12px 14px",background:pd.meetsMinReq===false?"#fff5f5":pd.meetsMinReq===true?"#E8F5EC":"#fafafa"}}>
                            ...
                            <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:8}}>
                              {[{val:true,label:"✅ Fulfills All Requirements"},{val:false,label:"❌ Does Not Fulfill"}].map(({val,label})=>(
                                <label key={String(val)} style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",fontWeight:pd.meetsMinReq===val?700:400,color:pd.meetsMinReq===val?(val?"#0E9E6E":"#c0392b"):"#555"}}>
                                  <input type="radio" name={`meetsMinReq-${prop.id}`} checked={pd.meetsMinReq===val} onChange={()=>upd("meetsMinReq",val)} style={{accentColor:val?"#10B981":"#e74c3c"}}/>
                                  {label}
                                </label>
                              ))}
                            </div>
                            <div style={{fontSize:11,fontWeight:600,color:"#888",marginBottom:3}}>REMARKS</div>
                            <input style={{...inputSt,borderColor:"#CFEFD7"}} value={pd.meetsMinReqComment||""} onChange={e=>upd("meetsMinReqComment",e.target.value)} placeholder="Optional remarks on compliance…"/>
                          </div>
                        </div>
                      );
                    })()}
                  ...
                  <div key={b.id} className="card-entry" style={{marginBottom:"16px"}}>
                    <div className="card-entry-header" style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                      ...
                      <button
                        ...
                        style={{fontSize:"11px",padding:"3px 10px",background:"#E8F5EC",color:"#0E9E6E",border:"1px solid #BFE3C9",borderRadius:"4px",cursor:"pointer",fontWeight:600,whiteSpace:"nowrap"}}
                      >
      ...
      render: () => (
        <div>
                        ...
                        {splits.map((sp, si) => {
                          ...
                          return (
                            <tr key={sp.id} style={{background:"#fffaf5"}}>
                              ...
                              <td className="calc-cell" style={{color:"#0E9E6E",fontWeight:700}}>
              ...
              <tbody>
                      ...
                      <React.Fragment key={p.id}>
                        {splits.map((sp, si) => {
                          ...
                          return (
                            <tr key={sp.id} style={{background:"#fffaf5"}}>
                              ...
                              <td className="calc-cell" style={{color:"#0E9E6E"}}>
                        ...
                        {(()=>{
                          ...
                          <tr style={{background:"#f0ece6",fontWeight:600}}>
                            ...
                            <td className="highlight" style={{color:"#0E9E6E"}}>NPR {gVal.toLocaleString("en-NP",{minimumFractionDigits:2,maximumFractionDigits:2})}</td>
                          ...
                          <tr style={{background:"#E8F5EC"}}>
                            ...
                            <td className="highlight" style={{color:"#0E9E6E"}}><strong>NPR {gValR.toLocaleString("en-NP")}</strong></td>
                            <td className="highlight" style={{color:"#0E9E6E"}}><strong>NPR {cvR.toLocaleString("en-NP")}</strong></td>
                            <td className="highlight" style={{color:"#0E9E6E"}}><strong>NPR {fvR.toLocaleString("en-NP")}</strong></td>
                            <td className="highlight" style={{color:"#0E9E6E"}}><strong>NPR {dvR.toLocaleString("en-NP")}</strong></td>
                          </tr>
                          </>);
                        })()}
                      </React.Fragment>
                ...
                {mortgaged.length > 0 && (
                  <tr className="total-row">
                    ...
                    <td className="highlight" style={{color:"#0E9E6E"}}><strong>NPR {finalGovValue.toLocaleString("en-NP")}</strong></td>
                        ...
                        <table>
                          ...
                          <tbody>
                            ...
                            <tr style={{background:"#E8F5EC"}}>
                              ...
                              <td className="highlight" style={{color:"#0E9E6E"}}><strong>NPR {calc.roundedValue.toLocaleString("en-NP")}</strong></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
          ...
          <div className="summary-box">
            ...
            {/* ── A. Commercial Value ── */}
            <div style={{margin:"16px 0 8px",border:"2px solid #0E9E6E",borderRadius:"8px",overflow:"hidden"}}>
              <div style={{background:"#0E9E6E",color:"#fff",padding:"8px 14px",fontWeight:700,fontSize:"13px",letterSpacing:"0.3px"}}>
                A. Commercial Value of Property
              </div>
              <div style={{padding:"10px 14px",background:"#E8F5EC"}}>
                <div style={{display:"flex",justifyContent:"space-between",padding:"6px 10px",marginBottom:"4px",background:"#fff",borderRadius:"5px",fontSize:"13px",border:"1px solid #CFEFD7"}}>
                ...
                <div style={{display:"flex",justifyContent:"space-between",padding:"8px 10px",background:"#0E9E6E",color:"#fff",borderRadius:"5px",fontSize:"14px",fontWeight:700,marginTop:"6px"}}>
                  <span>Total Commercial Value (A)</span>
                  <span>NPR {finalCommercialValue.toLocaleString("en-NP")}</span>
                </div>
                <div style={{marginTop:"8px",padding:"8px 10px",background:"#E8F5EC",borderRadius:"5px",fontSize:"12px",color:"#0E9E6E",fontStyle:"italic",borderLeft:"3px solid #0E9E6E"}}>
            ...
            {/* ── D. Government Value ── */}
            {finalGovValue > 0 && (
            <div style={{margin:"8px 0",border:"2px solid #0E9E6E",borderRadius:"8px",overflow:"hidden"}}>
              <div style={{background:"#0E9E6E",color:"#fff",padding:"8px 14px",fontWeight:700,fontSize:"13px",letterSpacing:"0.3px"}}>
              ...
              <div style={{padding:"10px 14px",background:"#E8F5EC"}}>
                {mortgaged.map(p=>{
                  ...
                  return (
                    <div key={p.id} style={{display:"flex",justifyContent:"space-between",padding:"6px 10px",marginBottom:"4px",background:"#fff",borderRadius:"5px",fontSize:"13px",border:"1px solid #BFE3C9"}}>
            ...
            <div className="sub-grid" style={{gridTemplateColumns:"1fr"}}>
              ...
              <Field label="Limiting Conditions">
                <label style={{display:"flex",alignItems:"center",gap:"8px",marginBottom:"6px",fontWeight:"600",fontSize:"13px",cursor:"pointer",userSelect:"none"}}>
                  <input type="checkbox" checked={includeLimitingConditions} onChange={e=>setIncludeLimitingConditions(e.target.checked)} style={{width:"15px",height:"15px",accentColor:"#0A6B50",cursor:"pointer"}}/>
                      ...
                      <div key={sp.id} style={{
                        ...
                        {sp.dataUrl?.startsWith("data:image") ? (
                          ...
                          <div style={{height:"100px",display:"flex",alignItems:"center",
                            justifyContent:"center",background:"#E8F5EC",fontSize:"32px",cursor:"pointer"}}
                            onClick={()=>{setViewerDoc({id:sp.id,dataUrl:sp.dataUrl,name:sp.name||`Plan ${i+1}`,source:"sitePlan"});setViewerRotation(sp.rotation||0);}}>
                            📄
                          </div>
                        )}
                          ...
                          {catDocs.map((doc, di) => (
                            <div key={doc.id} style={{
                              ...
                              {doc.dataUrl?.startsWith("data:image") ? (
                                ...
                                <div style={{height:"100px",display:"flex",alignItems:"center",
                                  justifyContent:"center",background:"#E8F5EC",fontSize:"32px",
                                  cursor:"pointer"}}
                                  onClick={()=>{setViewerDoc({id:doc.id,dataUrl:doc.dataUrl,name:doc.name||`File ${di+1}`});setViewerRotation(doc.rotation||0);}}>
                                  📄
                                </div>
  ...
  return (
    <div className="app">
          ...
          <div style={{background:"#fff",borderRadius:"12px",padding:"32px 28px",maxWidth:"420px",width:"90%",boxShadow:"0 8px 32px rgba(0,0,0,0.25)",fontFamily:"'Segoe UI',sans-serif"}}>
            ...
            <div style={{display:"flex",gap:"12px",justifyContent:"center"}}>
              <button
                ...
                style={{padding:"9px 32px",background:"#0E9E6E",color:"#fff",border:"none",borderRadius:"7px",fontSize:"14px",fontWeight:600,cursor:"pointer"}}
              >Yes</button>
              <button
                onClick={()=>setGuthiAlert(null)}
      ...
      <style>{`
        /* Poppins is loaded once in index.html — see constants/brand.js */
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }

        :root {
          /* Core palette — Mulyanka forest green + emerald/gold accents */
          --navy:        #064E3B;
          --navy-2:      #0A6B50;
          --navy-3:      #0A6B50;
          --gold:        #D4AF37;
          ...
          --brand-gold:    #D4AF37;
          --brand-sweep:   linear-gradient(100deg,#064E3B 0%,#10B981 58%,#D4AF37 100%);
          ...
          --radius:      8px;
          --radius-lg:   14px;
          --shadow-sm:   0 1px 3px rgba(6, 78, 59,0.07), 0 2px 8px rgba(6, 78, 59,0.05);
          --shadow:      0 4px 16px rgba(6, 78, 59,0.10), 0 1px 3px rgba(6, 78, 59,0.06);
        ...
        .report-badge.preliminary {
          background: rgba(212, 175, 55,0.2); border: 1px solid rgba(232,184,75,0.5);
          color: #f0c060;
        }
        .report-badge.final {
        ...
        .modal-header strong { font-size: 14px; font-family: 'Poppins', system-ui, sans-serif; font-weight: 400; }
        ...
        .modal-close {
          ...
          font-size: 13px; font-weight: 600; font-family: 'Poppins', system-ui, sans-serif;
        ...
        .modal-print-btn {
          ...
          font-family: 'Poppins', system-ui, sans-serif; transition: all 0.15s;
        }
        ...
        .action-btn {
          ...
          font-weight: 600; cursor: pointer; font-family: 'Poppins', system-ui, sans-serif;
          transition: all 0.18s cubic-bezier(0.4,0,0.2,1);
        ...
        .action-btn.open   { background: #E8F5EC; border-color: var(--navy-2); color: var(--navy-2); }
        ...
        .nav-tabs {
          ...
          background: linear-gradient(180deg, #04382A 0%, var(--navy) 100%);
        ...
        .nav-tab:hover .nav-tab-num { background: rgba(212, 175, 55,0.25); color: var(--gold-light); }
        .nav-tab.active {
          color: #fff;
        ...
        .sec-num {
          background: linear-gradient(135deg, var(--navy) 0%, var(--navy-2) 100%);
          color: white; font-family: 'Poppins', system-ui, sans-serif;
        ...
        .sec-title {
          font-family: 'Poppins', system-ui, sans-serif; font-size: 19px;
        ...
        input[type=password], select, textarea {
          ...
          border-radius: 10px;
          padding: 10px 14px;
          font-size: 14px; font-family: 'Poppins', system-ui, sans-serif;
        ...
        input:focus, select:focus, textarea:focus {
          ...
          box-shadow: 0 0 0 3px rgba(212, 175, 55,0.12), 0 0 0 1px var(--gold-border);
        }
        ...
        .ndp-selects select:focus { outline: none; border-color: var(--gold); box-shadow: 0 0 0 3px rgba(212, 175, 55,0.12); }
        ...
        .abhilekh-remark { margin-top: 8px; width: 100%; padding: 8px 12px; border: 1.5px solid #d97706; border-radius: 5px; font-size: 13px; font-family: 'Poppins', system-ui, sans-serif; background: white; }
        ...
        .btn-add {
          ...
          font-size: 12px; font-weight: 600; cursor: pointer; font-family: 'Poppins', system-ui, sans-serif;
          transition: all 0.15s;
        }
        ...
        .btn-add-main {
          ...
          font-size: 13px; font-weight: 600; cursor: pointer; font-family: 'Poppins', system-ui, sans-serif;
          transition: all 0.15s;
        }
        ...
        .calc-cell { font-family: 'IBM Plex Mono', ui-monospace, monospace; color: var(--text-2); }
        ...
        .valuation-total {
          ...
          font-family: 'Poppins', system-ui, sans-serif; font-size: 18px;
        ...
        .btn-nav {
          ...
          font-family: 'Poppins', system-ui, sans-serif; transition: all 0.18s;
        }
        ...
        /* ── Selection ───────────────────────────────────────────── */
        ::selection { background: rgba(212, 175, 55,0.2); color: var(--navy); }
      ...
      <div className="app-header">
        <div className="header-top">
          {/* Left: product wordmark (also balances the 3-column grid) */}
          <div className="header-brand"><Wordmark size={28} tone="light" /></div>
      ...
      {showRestoreBanner && (
        <div style={{
          background:"#064E3B", color:"#A7E3B1", padding:"10px 20px",
          display:"flex", alignItems:"center", gap:"12px", flexWrap:"wrap",
          fontSize:"13px", borderBottom:"1px solid #0E9E6E", zIndex:50, position:"relative"
        }}>
          <span style={{fontSize:"16px"}}>💾</span>
          <span style={{flex:1}}>
          ...
          <button
            ...
            style={{padding:"6px 16px",background:"#0E9E6E",color:"#fff",border:"none",
              borderRadius:"6px",fontWeight:700,fontSize:"13px",cursor:"pointer"}}>
            ↩ Restore Draft
          </button>
          <button
            onClick={clearAutosave}
            style={{padding:"6px 12px",background:"rgba(255,255,255,0.1)",color:"#A7E3B1",
      ...
      <div className="content">
        ...
        <div className="section-nav">
          ...
          <button
            className="btn-nav"
            style={{background:"#0E9E6E",color:"#fff",opacity:dbSaving?0.7:1}}
        ...
        {dbMsg && (
          <div style={{textAlign:"center",padding:"6px 12px",fontSize:13,color:dbMsg.startsWith("⚠")?"#c0392b":"#0E9E6E",background:dbMsg.startsWith("⚠")?"#fdf0f0":"#E8F5EC",borderTop:"1px solid #e5e7eb"}}>
            {dbMsg}
          </div>
        )}
      </div>{/* end .content */}
