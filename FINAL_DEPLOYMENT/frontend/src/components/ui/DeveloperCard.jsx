      ...
      >
        ...
        <div style={{ padding: "22px 28px 28px" }}>
          ...
          <div style={{
            ...
            padding: "12px 16px",
            background: "#E8F5EC", borderRadius: 10,
            marginBottom: 18,
          }}>
            <div style={{
              width: 42, height: 42, borderRadius: "50%",
              background: "linear-gradient(135deg, #10B981, #0E9E6E)",
              display: "flex", alignItems: "center", justifyContent: "center",
            ...
            <div>
              <div style={{ fontWeight: 700, fontSize: 15, color: "#064E3B" }}>{DEV_INFO.person}</div>
              <div style={{ fontSize: 12, color: "#7A8F87", marginTop: 1 }}>Developer &amp; Consultant</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
            {[
              ...
              <div key={label} style={{
                display: "flex", alignItems: "center", gap: 12,
                padding: "9px 14px",
                border: "1.5px solid #D6DCE5", borderRadius: 8,
                background: "#F8FAF9",
              }}>
                <span style={{ fontSize: 18, flexShrink: 0 }}>{icon}</span>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: "#7A8F87", textTransform: "uppercase", letterSpacing: "0.5px" }}>{label}</div>
                  {href ? (
                    <a href={href} target="_blank" rel="noreferrer"
                      style={{ fontSize: 13, color: "#10B981", fontWeight: 500, textDecoration: "none", wordBreak: "break-all" }}>
                      {value}
                    </a>
                  ) : (
                    <div style={{ fontSize: 13, color: "#3D5A50", fontWeight: 500 }}>{value}</div>
                  )}
                </div>
              </div>
            ))}
          ...
          <div style={{ marginBottom: 20 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#7A8F87", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: 8 }}>Services</div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {DEV_INFO.services.map(s => (
                <span key={s} style={{
                  background: "#E8F5EC", color: "#10B981",
