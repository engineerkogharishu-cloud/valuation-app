...
// Offline/no-backend bundle. Output stays inside FINAL_DEPLOYMENT so the
// package is self-contained; drag this folder to netlify.com/drop.
const OUT = path.resolve(__dirname, "../standalone-build");
...
function netlifyFinalize() {
  return {
    ...
    closeBundle() {
      ...
      console.log("✅  standalone-build ready — drag the folder to netlify.com/drop");
    },
  };
}
